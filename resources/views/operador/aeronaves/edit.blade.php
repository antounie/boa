                ...
                <form method="POST" action="{{ route('operador.aeronaves.update', $aeronave) }}">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('matricula') is-invalid @enderror"
                                   id="matricula" name="matricula" value="{{ old('matricula', $aeronave->matricula) }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control @error('capacidad_total') is-invalid @enderror"
                                   id="capacidad_total" name="capacidad_total" value="{{ old('capacidad_total', $aeronave->capacidad_total) }}"
                                   min="1" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('modelo') is-invalid @enderror"
                               id="modelo" name="modelo" value="{{ old('modelo', $aeronave->modelo) }}" required>
                        @error('modelo')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('fabricante') is-invalid @enderror"
                               id="fabricante" name="fabricante" value="{{ old('fabricante', $aeronave->fabricante) }}" required>
                        @error('fabricante')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-warning">
                            <i class="bi bi-check-lg"></i> Actualizar Aeronave
                        </button>
                    </div>
                </form>
            </div>
